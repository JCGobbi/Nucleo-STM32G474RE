...
package Ada.Interrupts.Names is
   ...
   --  HRTIM_Master
   HRTIM_Master_Interrupt      : constant Interrupt_ID := 67;

   --  HRTIM_TIMA
   HRTIM_TIMA_Interrupt        : constant Interrupt_ID := 68;

   --  HRTIM_TIMB
   HRTIM_TIMB_Interrupt        : constant Interrupt_ID := 69;

   --  HRTIM_TIMC
   HRTIM_TIMC_Interrupt        : constant Interrupt_ID := 70;

   --  HRTIM_TIMD
   HRTIM_TIMD_Interrupt        : constant Interrupt_ID := 71;

   --  HRTIM_TIME
   HRTIM_TIME_Interrupt        : constant Interrupt_ID := 72;

   --  HRTIM_TIM_FLT
   HRTIM_TIM_FLT_Interrupt     : constant Interrupt_ID := 73;

   --  HRTIM_TIMF
   HRTIM_TIMF_Interrupt        : constant Interrupt_ID := 74;
